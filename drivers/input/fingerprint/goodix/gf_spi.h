...
#define GF_NAV_INPUT_UP			KEY_GESTURE_NAV_RIGHT
#define GF_NAV_INPUT_DOWN		KEY_GESTURE_NAV_LEFT
#define GF_NAV_INPUT_LEFT		KEY_GESTURE_NAV_UP
#define GF_NAV_INPUT_RIGHT		KEY_GESTURE_NAV_DOWN
